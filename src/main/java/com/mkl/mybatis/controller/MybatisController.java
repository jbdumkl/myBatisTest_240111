package com.mkl.mybatis.controller;
...
import com.mkl.mybatis.dao.MemberDao;
import com.mkl.mybatis.dao.MybatisDao;
...
public class MybatisController {
	...
	public String content_view(HttpServletRequest request, Model model) {
		...
		MybatisDao dao = sqlSession.getMapper(MybatisDao.class);//dao 객체 분리 생성
		dao.uphitDao(request.getParameter("fbnum"));//조회수 증가함수 호출
